"""This module use code from ``kedro.config`` : https://github.com/kedro-org/kedro/tree/main/kedro/config
"""
from pathlib import Path
from typing import Any, Dict, Iterable

from .abstract_config import AbstractConfigLoader
from .common import _get_config_from_patterns, _remove_duplicates
